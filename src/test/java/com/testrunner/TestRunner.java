...
public class TestRunner extends AbstractTestNGCucumberTests {
	...
	@BeforeClass
	@Parameters({ "Platform", "deviceName", "platformName", "platformVersion", "appPackage", "appActivity",
			"sPlatformAppPath", "sPlatformIpAddress", "deviceId", "port" })
	public void beforeSetup(String platform, String deviceName, String platformName, String platformVersion,
		...
		MobileSetup.setMobile(platform, deviceName, platformName, platformVersion, appPackage, appActivity,
				sPlatformAppPath, sPlatformIpAddress, deviceId, port);
